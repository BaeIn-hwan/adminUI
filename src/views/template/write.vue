	...
	<div class="temp-write">
		<section class="layout-wrapper">
			<div class="layout-header">
				<h3 class="layout-header__title">템플릿 등록</h3>
					...
					<tbody class="cols-table__tbody">
						<tr class="cols-table__tr">
							...
							<td class="cols-table__td">
								<input v-model="sampleWrite.title" type="text" class="cols-table__input" maxlength="100" @input="textWrite($event, 'title')">
							</td>
						</tr>
						...
						<tr class="cols-table__tr">
							...
							<td class="cols-table__td">
								<textarea v-model="sampleWrite.content" cols="30" rows="10" class="cols-table__textarea" maxlength="100" @input="textWrite($event, 'content')"></textarea>
							</td>
						</tr>
					</tbody>
				</table>
